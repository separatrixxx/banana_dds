export const en = {
    ...
    welcome_to_banana_dds: "Welcome to banana.dds",
    start_text1: "Your internet - your rules. banana.dds will provide security, anonymity and free access to any content.",
    start_text2: "Choose one of three tariffs and use the Internet without restrictions! banana.dds is your online shield.",
    monthly: "Monthly",
    yearly: "Yearly",
    per_month: "per month",
    per_year: "per year",
