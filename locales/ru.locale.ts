export const ru = {
    ...
    welcome_to_banana_dds: "Добро пожаловать в banana.dds",
    start_text1: "Твой интернет — твои правила. banana.dds обеспечит безопасность, анонимность и свободный доступ к любому контенту.",
    start_text2: "Выбирай один из трёх тарифов и используй интернет без ограничений! banana.dds — твой онлайн-щит.",
    monthly: "На месяц",
    yearly: "На год",
    per_month: "в месяц",
    per_year: "в год",
